...
## 概要
🎙️ VoiceHook Cardは、月$20達成を最短で狙う小粒プロダクト。海外で伸びる体験を日本語UXに寄せ、**低固定費・高粗利**で回す。

## 海外事例分析
- 参照: Headliner / Descript / OpusClip
- 示唆:
...
## この案の具体仕様（差別化）
- 入力: YouTube/Podcast URL
- 処理: 音声要点抽出→冒頭15秒向け“フック文”3案生成
- 出力: 埋め込み可能な見出しカード（OG画像付き）
- 海外トレンド適合: short clip文化を「全文編集」ではなく「導入最適化」に限定
