...
## 概要
FocusPebbleは、パーソナル生産性（1タップ集中→成果カード）に特化した月$20到達向けマイクロプロダクト。初期は1人開発（AIエージェント実装）で、AWS無料枠+低コスト構成を前提に収益化する。

## 海外事例分析
- 参照: **Lifestack / Rize / done-list movement**
