...
| プロダクト | カテゴリ | 海外事例 | 評価 | 粗利率 |
|-----------|---------|---------|------|--------|
| [🎬 HookCanvas](hookcanvas.md) ([レビュー](hookcanvas-review.md)) | AI動画フック設計 | Captions / CapCut | **A** | 93.8% |
| [👥 CrewLoop](crewloop.md) ([レビュー](crewloop-review.md)) | 少人数実行コミュニティ | Focusmate / Caveday | **A** | 99.1% |
| [🧭 DayStack](daystack.md) ([レビュー](daystack-review.md)) | 1日設計の個人生産性ツール | Sunsama / Motion | **A** | 98.3% |
| [🚀 WaitKit](waitkit.md) ([レビュー](waitkit-review.md)) | waitlist拡散マイクロSaaS | Prefinery / Viral Loops | **A** | 99.0% |
| [🧵 ThreadFrame](threadframe.md) ([レビュー](threadframe-review.md)) | テキスト→カルーセル制作 | Typefully / Taplio | **A** | 96.5% |

### v13の特徴
- **5カテゴリ完全分散**: クリエイティブ / コミュニティ / 生産性 / マイクロSaaS / クリエイター
- **保険型依存から脱却**: 「守る」より「作る・広げる・続ける」価値を主軸
- **デザイン重視**: 共有したくなる見た目と演出を各案に実装
- **$20達成の現実性**: 各案3〜5ユーザーで目標到達
- **AIコスト最適化**: 生成はminiモデル優先、固定費を月$5未満に維持

---
## 🌍 新領域5カテゴリ設計 v12（2026-02-22）

インバウンド×飲食テック / AIビジネスツール / ネットワーキング / クリエイターエコノミー / 教育の5カテゴリで設計。保険型ゼロ、全案海外実証済み、全案A評価。

| プロダクト | カテゴリ | 海外事例 | 評価 | 粗利率 |
|-----------|---------|---------|------|--------|
| [🍱 SnapMenu](snapmenu.md) ([レビュー](snapmenu-review.md)) | AI飲食店メニューデジタル化 | Menufy ($50M+ ARR) | **A** | 95.2% |
| [🎯 PitchCraft](pitchcraft.md) ([レビュー](pitchcraft-review.md)) | AIピッチデッキ自動生成 | Gamma.app ($25M+ ARR) | **A** | 93.8% |
| [📇 DigiMeishi](digimeishi.md) ([レビュー](digimeishi-review.md)) | デジタル名刺 | Popl ($10M+ ARR) | **A** | 99.2% |
| [🎨 PromptStock](promptstock.md) ([レビュー](promptstock-review.md)) | AIプロンプトマーケットプレイス | PromptBase ($2M+/年) | **A** | 97.5% |
| [🏅 MicroCert](microcert.md) ([レビュー](microcert-review.md)) | デジタル認定証・バッジ作成 | Credly ($100M+ 買収) | **A** | 98.5% |

### v12の特徴
- **5カテゴリ完全分散**: 飲食テック / ビジネスツール / ネットワーキング / マーケットプレイス / 教育
- **保険型ゼロ**: 全てが「作る・売る・つながる」系プロダクト
- **全案海外実証済み**: $2M〜$100M規模の成功事例あり
- **3/5がAI不使用**: DigiMeishi/PromptStock/MicroCertはAI費用$0
- **バイラル性重視**: DigiMeishi（名刺交換で自然拡散）、MicroCert（SNSシェアで拡散）
- **インバウンド活用**: SnapMenuは訪日3,600万人市場を狙い撃ち
