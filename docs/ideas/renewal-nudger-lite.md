# 🛡️ Renewal Nudger Lite

## 概要
Renewal Nudger Liteは、保険型（SaaS更新前の無駄課金防止）に特化した月$20到達向けマイクロプロダクト。初期は1人開発（AIエージェント実装）で、AWS無料枠+低コスト構成を前提に収益化する。

## 海外事例分析
- 参照: **Rocket Money / Subby / Zluri usage optimization**
