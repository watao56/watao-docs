...
## 概要
TinyRoast Clubは、月$20達成を狙う小粒SaaS。**ソーシャル/コミュニティ（相互フィードバック）**として、初期は1人開発+AIエージェント実装で2週間MVPを前提。

## 海外事例分析
- 参照: **Roast My Landing Page、Indie Hackers、Figma Community**
